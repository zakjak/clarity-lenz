...
const ConsultingPage = () => {
  const consultings = [
    ...
    },
    {
      ...
      icon: (
        <PiBagDuotone size={40} className="text-blue-900 dark:text-blue-500" />
      ),
    },
    {
      id: 3,
    ...
    },
    {
      ...
      icon: (
        <TbTargetArrow size={40} className="text-blue-900 dark:text-blue-500" />
      ),
    },
    {
      id: 5,
      ...
      description:
        "Speech delivery, confidence building and effective audience engagement.",
      icon: (
  ...
  return (
    <div className="pt-8">
      ...
      <h3 className="mt-4 text-sm text-zinc-700 dark:text-zinc-200 text-center">
      ...
      <div className="grid md:grid-cols-2 gap-4 max-w-280 mx-auto mt-8 p-4">
        {consultings.map((consult) => (
          <div
            className=" bg-white dark:bg-zinc-950 shadow-lg dark:shadow-2xl dark:shadow-zinc-950 px-6 py-4"
            key={consult.id}
          >
            <div className="flex items-center gap-2 border-b w-full">
              {consult.icon}
              <h2 className="text-xl text-blue-900 dark:text-blue-500 font-semibold">
                {consult.title}
              </h2>
            </div>
      ...
      <div className="">
        ...
        <h3 className="mt-4 text-sm text-zinc-700 text-center dark:text-zinc-200">
        ...
        <div className="grid md:grid-cols-2 gap-4 max-w-280 mx-auto my-8 p-4">
          {contacts.map((contact) => (
            <div
              className=" bg-white shadow-lg px-6 py-4 dark:bg-zinc-950 dark:shadow-2xl dark:shadow-zinc-950"
              key={contact.id}
            >
              <div className="flex items-center gap-2 border-b w-full">
                <h2 className="text-xl text-blue-900 dark:text-blue-500 font-semibold">
